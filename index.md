...
* **[Fashion-MNIST Image Classification Pipeline](https://github.com/Gerard-bll/fashion-mnist-classification)** | An end-to-end classification pipeline comparing Machine Learning ensembles (Random Forest, Logistic Regression) against a custom Deep Learning Convolutional Neural Network (CNN), integrated with a Generative AI semantic search engine.
